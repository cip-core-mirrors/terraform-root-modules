...
module "organization_access_group_root" {
  source              = "git::https://github.com/cip-core-mirrors/terraform-aws-iam-assumed-roles.git?ref=tags/0.7.0"
...
module "organization_access_group_ssm_root" {
  source = "git::https://github.com/cip-core-mirrors/terraform-aws-ssm-parameter-store?ref=tags/0.2.1"
